...
$string['canceldeletedmeetingtask'] = 'Cancel deleted Google Meet Calendar event';
$string['reconcileremotecleanupstask'] = 'Reconcile deleted Google Meet Calendar events';
$string['reconcileremotecleanupsresult'] = 'Remote Calendar cleanup reconciliation found {$a->found} obligation(s) and queued {$a->queued} task(s).';
$string['remotecleanupcompleted'] = 'Remote Calendar cleanup {$a} completed.';
$string['remotecleanuplocktimeout'] = 'Could not acquire the lock for remote Calendar cleanup {$a}.';
$string['remotecleanupmissing'] = 'Remote Calendar cleanup {$a} no longer exists; no action is required.';
$string['privacy:metadata:googlemeet_remote_cleanup'] = 'Durable Calendar cancellation obligations retained after a managed activity is deleted.';
$string['privacy:metadata:googlemeet_remote_cleanup:cleanupkey'] = 'A one-way idempotency key derived from the remote event identity.';
$string['privacy:metadata:googlemeet_remote_cleanup:owneruserid'] = 'The Moodle user whose Google authorization owns the remote event.';
$string['privacy:metadata:googlemeet_remote_cleanup:oauthissuerid'] = 'The OAuth issuer used to authorize cancellation.';
$string['privacy:metadata:googlemeet_remote_cleanup:calendarid'] = 'The Google Calendar identifier containing the remote event.';
$string['privacy:metadata:googlemeet_remote_cleanup:googleeventid'] = 'The Google Calendar event identifier awaiting cancellation.';
$string['privacy:metadata:googlemeet_remote_cleanup:guestcount'] = 'The last managed attendee count used for cancellation notifications.';
$string['privacy:metadata:googlemeet_remote_cleanup:status'] = 'The current durable cancellation state.';
$string['privacy:metadata:googlemeet_remote_cleanup:attempts'] = 'The number of remote cancellation attempts.';
$string['privacy:metadata:googlemeet_remote_cleanup:lasterrorcode'] = 'The stable sanitized code from the last cancellation failure.';
$string['privacy:metadata:googlemeet_remote_cleanup:timecreated'] = 'When the cancellation obligation was captured.';
$string['privacy:metadata:googlemeet_remote_cleanup:timelastattempt'] = 'When remote cancellation was last attempted.';
$string['privacy:metadata:googlemeet_remote_cleanup:timenextattempt'] = 'When a blocked cancellation may next be retried.';
$string['privacy:path:remotecleanups'] = 'Pending remote Calendar cancellations';
