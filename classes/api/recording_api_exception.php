...
/**
 * A permanent Google Meet recording API rejection.
 *
 * @package     mod_googlemeet
 * @copyright   2026 Anderson Rodrigues
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class recording_api_exception extends \RuntimeException {
    ...
    public function __construct(string $errorcode, ?\Throwable $previous = null) {
        ...
        parent::__construct('The Google Meet recording API rejected the request.', 0, $previous);
    }
